...
var _ = Describe("E2E - Install Rancher Manager", Label("install"), func() {
	...
	It("Install Rancher Manager", func() {
		By("Installing K3s", func() {
			...
			installCmd.Env = append(os.Environ(), "INSTALL_K3S_VERSION="+os.Getenv("INSTALL_K3S_VERSION"))
			installCmd.Env = append(os.Environ(), "K3S_KUBECONFIG_MODE="+os.Getenv("K3S_KUBECONFIG_MODE"))
